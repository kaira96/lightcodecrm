    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('assignment_name_ru', models.CharField(max_length=50, null=True, verbose_name='Название')),
                ('assignment_name_ky', models.CharField(max_length=50, null=True, verbose_name='Название')),
                ('due_date', models.DateField(verbose_name='Срок сдачи')),
                ('due_time', models.TimeField(default=datetime.time(16, 48, 7, 605664), verbose_name='Время сдачи')),
                ...
                ('instruction_ru', models.TextField(null=True, verbose_name='Инструкция')),
                ('instruction_ky', models.TextField(null=True, verbose_name='Инструкция')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('classroom_name_ru', models.CharField(max_length=99, null=True, verbose_name='Название')),
                ('classroom_name_ky', models.CharField(max_length=99, null=True, verbose_name='Название')),
                ('section', models.CharField(max_length=99, verbose_name='Раздел')),
                ('section_ru', models.CharField(max_length=99, null=True, verbose_name='Раздел')),
                ('section_ky', models.CharField(max_length=99, null=True, verbose_name='Раздел')),
